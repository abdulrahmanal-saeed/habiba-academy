<?php
// api/teacher/quick-block-save.php — Create or update a quick test block (passage + questions)
...
$blockId   = (int)($_POST['block_id']   ?? 0);  // 0 = new
$passageAr = trim((string)($_POST['passage_ar'] ?? ''));
$sortOrder = (int)($_POST['sort_order'] ?? 0);
$isActive  = (int)($_POST['is_active']  ?? 1);

// questions: array of {id?, question_ar, opt_a, opt_b, opt_c?, opt_d?, correct_opt}
...
try {
    ...
    // Replace all questions for this block
