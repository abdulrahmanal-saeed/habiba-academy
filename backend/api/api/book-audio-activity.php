...
if (!$lesson || $audioKey === '' || !interactive_books_student_can_access($pdo, $studentId, (int)$lesson['book_id'])) {
    json_err('Invalid audio activity.');
}
...
");
$stmt->execute([$studentId, (int)$lesson['book_id'], $lessonId, $audioKey, $marked]);
json_ok();
